...
<div id="homepage-4">
    <div class="ps-page--single">
        ...
        <div class="ps-vendor-banner bg--cover" data-background="/assets_main/img/bg/vendor.jpg">
            <div class="container">
                <h2>Millions Of Shoppers Can’t Wait To See What You Have In Store</h2><a class="ps-btn ps-btn--lg" href="/user">РЕГИСТРАЦИЯ</a>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                            <div class="ps-block--icon-box-2">
                                <div class="ps-block__thumbnail"><img src="/assets_main/img/icons/vendor-1.png" alt=""></div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                            <div class="ps-block--icon-box-2">
                                <div class="ps-block__thumbnail"><img src="/assets_main/img/icons/vendor-2.png" alt=""></div>
                                <div class="ps-block__content">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                            <div class="ps-block--icon-box-2">
                                <div class="ps-block__thumbnail"><img src="/assets_main/img/icons/vendor-3.png" alt=""></div>
                                <div class="ps-block__content">
                                    <h4>Support 24/7</h4>
                                    <div class="ps-block__desc" data-mh="about-desc">
                                        <p>Our tools and services make it easy to manage, promote and grow your business.</p>
            ...
            <div class="container">
                ...
                <div class="ps-section__content">
                    <div class="ps-block--vendor-milestone">
                        ...
                        <div class="ps-block__right"><img src="/assets_main/img/vendor/milestone-1.png" alt=""></div>
                    ...
                    <div class="ps-block--vendor-milestone reverse">
                        ...
                        <div class="ps-block__right"><img src="/assets_main/img/vendor/milestone-2.png" alt=""></div>
                    ...
                    <div class="ps-block--vendor-milestone">
                        ...
                        <div class="ps-block__right"><img src="/assets_main/img/vendor/milestone-3.png" alt=""></div>
                    ...
                    <div class="ps-block--vendor-milestone reverse">
                        ...
                        <div class="ps-block__right"><img src="/assets_main/img/vendor/milestone-4.png" alt=""></div>
        ...
        <div class="ps-section--vendor ps-vendor-best-fees">
            <div class="container">
                ...
                <div class="ps-section__content">
                    ...
                    <div class="ps-section__highlight"><img src="/assets_main/img/icons/vendor-4.png" alt="">
                        <figure>
    ...
    <div class="ps-home-promotions" style="padding-top: 30px;">
        ...
        <div class="container">
            <div class="row">
                ...
                <?php foreach ($couponsliseder as $key=>$val):?>

                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <a class="ps-collection mb-30" href="<?=$val['direct_link']?>" target="_blank"><img src="<?=$val['pictureurl']?>" height="300"  alt=""></a>
                    </div>
    ...
    <div class="ps-product-list">
        <div class="container">
            <div class="ps-section__header">
                <h3>Цифровая и бытовая техника</h3>
                <ul class="ps-section__links">
                    <li><a href="shop-grid.html">New Arrivals</a></li>
                    <li><a href="shop-grid.html">Best seller</a></li>
                    <li><a href="shop-grid.html">Must Popular</a></li>
